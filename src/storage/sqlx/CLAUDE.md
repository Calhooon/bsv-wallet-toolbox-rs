...
| `migrations/003_locked_input_checks.sql` | `locked_input_checks` (inputs THE RELEASE RULE kept locked, re-checked with backoff, 0.3.59); applied on `migrate()` AND `make_available()` |
